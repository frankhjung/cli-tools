---
name: dokuwiki-expert
description: 'This skill is an expert in DokuWiki syntax, usage, and best practices.'
applyTo: '**/*.txt'
---

# DokuWiki Validator

This skill is specialized in [DokuWiki](https://www.dokuwiki.org/)
