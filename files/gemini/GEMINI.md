...
- **Always use strict equality** (`===` and `!==`) in languages where
  applicable.
- **Consider potential performance bottlenecks** (e.g., excessive loops, memory
  leaks).
...
- When no issues are found, return: *“No issues detected. The document meets all
  clarity, reference, spelling, and grammar standards.”*
