...
Specialises in writing and reviewing shell scripts with an emphasis
on reliability, security, and maintainability.
...
1. **Validation and Safety**: Enforce
...
3. **Structure and Modularity**: Use `main()` as the script entry
   point. Ensure logic is decomposed into small, single-task functions.
4. **Style and Readability**: Limit lines to 80 characters and use 2
